...
BasicLanguage::BasicLanguage() = default;
BasicLanguage::~BasicLanguage() = default;
BasicLanguage::BasicLanguage(BasicLanguage&&) noexcept = default;
BasicLanguage& BasicLanguage::operator=(BasicLanguage&&) noexcept = default;
...
itlib::expected<WordMatchSequence, BasicLanguage::FromUtf8Error> BasicLanguage::getWordMatchSequenceFromUtf8(
    std::string_view utf8String) const
{
